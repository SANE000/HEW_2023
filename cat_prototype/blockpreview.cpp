...
void UpdatePreview()
{
	...
	{
		if (Keyboard_IsKeyDown(KK_RIGHT) && time <= 0 || IsButtonPressed(0, XINPUT_GAMEPAD_Y) && time <= 0)
		{//右
		...
		else if (Keyboard_IsKeyDown(KK_LEFT) && time <= 0 || IsButtonPressed(0, XINPUT_GAMEPAD_A) && time <= 0)
		{//左
